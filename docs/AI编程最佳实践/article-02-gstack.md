...
> **延伸阅读**：gstack 的全部源码在 [https://github.com/garrytan/gstack](https://github.com/garrytan/gstack) ，每个 skill 的 SKILL.md 都是可直接阅读的 Markdown，建议在终端 `cat ~/.claude/skills/gstack/ship/SKILL.md | less` 通读一遍。

---

*作者：[AI-Authored Tech Chronicles]*
*系列：《AI 编程最佳实践》第二篇*
*参考来源：garrytan/gstack（github.com/garrytan/gstack），skills 源码读取于 2026-03-30*
